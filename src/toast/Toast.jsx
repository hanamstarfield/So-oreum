...
const ToastPortal = () => {
    ...
    useEffect(() => {
        const handleToastEvent = (toast) => {
            ...
            setToasts((prevToasts) => {
                ...
                updatedToasts[toast.position] = [...updatedToasts[toast.position], newToast];
    ...
    const handleToastRemove = (toast) => {
        setToasts((prevToasts) => {
            const updatedToasts = { ...prevToasts };
            updatedToasts[toast.position] = updatedToasts[toast.position].filter((t) => t.id !== toast.id);
            return updatedToasts;
        });
    };
...
const Toast = ({ toast, onRemove }) => {
    ...
    const { getToastClass, getBoxStyle, getFontStyle, getProgressStyle, getIconUrl, getIconStyle } =
    ...
    return (
        <div
            ...
            style={{ ...boxStyle }}
        >
            <button type="button" className="toast-btn-close" onClick={() => handleClose(false)}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 50 50" width="15px" height="15px">
